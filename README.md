...
6. Не использовал jwt посколько сервис 1 нету экосистемы сервисов, сессия шариться cross-domain, если cookie-based и делаем запрос с другого домена с credentials: include., фикситься с rust_hydra.
